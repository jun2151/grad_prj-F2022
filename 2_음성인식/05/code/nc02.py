#url: https://github.com/dodiku/noise_reduction
# 효과 없음 
...
def reduce_noise_power(y, sr):
    ...
    threshold_l = round(np.median(cent))*1.0
...
for s in samples:
    ...
    import soundfile 
    soundfile.write("out.wav", y_reduced_power, sr, format='WAV')
    #soundfile.write("out.wav", y_reduced_mfcc_up, sr, format='WAV')
    #soundfile.write("out.wav", y_reduced_mfcc_down, sr, format='WAV')
    #soundfile.write("out.wav", y_reduced_median, sr, format='WAV')
